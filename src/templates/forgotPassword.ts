...
<body
                  ...
                  <tr>
                    <td class="sm-px-24"
                      ...
                      <p style="margin: 0 0 24px;">
                        This is the password reset Project SCM you requested from node-typescript-boilerplate. Use to reset your node-typescript-boilerplate account password.
                      </p>
  ...
  const text = `
        Reset Password, You recently requested to reset your password for your Project SCM account. Copy and paste it for reset password:
        ${otp}
